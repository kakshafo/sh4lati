...
┃╰━╯┃┃╱┃┃╭━╮┃┃╱╱┃╰━╯┃
╰━━━┻╯╱╰┻╯╱╰┻╯╱╱╰━━━╯
   Oo Shafo Oo Powerful DDOS Attack Tool // Oo Shafi Oo (shafo 404) // Facebook : shafo✓ & Telegram : 7usa_sh4lati 
...
def usage():
	...
	print '#  Facebook :  shafo  & Telegram : 7usa_sh4lati #'
	print '####################################################'
...
def chk():
  ...
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/kakshafo/ddos/main/Id.active.txt").text
    httpBand = requests.get("https://raw.githubusercontent.com/kakshafo/ddos/main/Id.active.txt").text
    if id in httpBand:
